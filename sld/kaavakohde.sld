  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>          <!-- MRL AK 2 | MRL YK 28 -->
          <se:Name>Asuinkerrostalo- ja rivitaloalue</se:Name>
          <ogc:Filter>
          <ogc:And>
            <ogc:And>
              <ogc:PropertyIsLike>
        ...
        <se:Rule>          <!-- MRL AK 2 | MRL YK 28 -->
          <se:Name>Erillispientalo- ja rivitaloalue</se:Name>
          <ogc:Filter>
          <ogc:And>
            <ogc:And>
              <ogc:PropertyIsLike>
      ...
      <se:Rule>          <!-- MRL AK 2 | MRL YK 28 -->
          <se:Name>Hoitoalan- ja opetusrakennusten alue</se:Name>
          <ogc:Filter>
          <ogc:And>
            <ogc:And>
              <ogc:PropertyIsLike>
 ...
 -->
        ...
        <se:Rule>
          ...
          <ogc:Filter>
            <ogc:And>
              ...
              <ogc:PropertyIsLike escapeChar="\" wildCard='%' singleChar='*'>
                <ogc:PropertyName>laji</ogc:PropertyName>
                <ogc:Literal>%ymparistoAsettaaToiminnanLaadulleErityisiaVaatimuksia%</ogc:Literal>
              </ogc:PropertyIsLike>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
        ...
        <se:Rule>          <!-- MRL AK 46 | MRL YK 53 -->
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              ...
              <se:SvgParameter name="opacity">0</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
          <se:LineSymbolizer>
            <se:Stroke>
        ...
        <se:Rule>          <!-- MRL AK 47 | MRL YK 58 -->
          ...
          <ogc:Or>
            ...
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>laji</ogc:PropertyName>
              <ogc:Literal>raideliikenteenAlue</ogc:Literal>
            </ogc:PropertyIsEqualTo>
            </ogc:Or>
          </ogc:Filter>
          <se:LineSymbolizer>
...
-->
        ...
        <se:Rule>          <!-- MRL AK 80 | MRL YK 82 -->
          <se:Name>Maa- ja metsätalousalue, jolla on erityinen ulkoilun ohjaamistarve</se:Name>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsLike escapeChar="\" wildCard='%' singleChar='*'>
                <ogc:PropertyName>laji</ogc:PropertyName>
              ...
              <ogc:PropertyIsLike>
                <ogc:PropertyName>laji</ogc:PropertyName>
                <ogc:Literal>%alueJollaOnErityistaUlkoilunOhjaamistarvetta%</ogc:Literal>
              </ogc:PropertyIsLike>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
       ...
       <se:Rule>          <!-- MRL AK 125 -->
          <se:Name>Jalankulku -ja pyöräilyalue</se:Name>
          <ogc:Filter>
          <ogc:And>
            <ogc:PropertyIsLike>
              <ogc:PropertyName>laji</ogc:PropertyName>
              <ogc:Literal>%jalankulkualue%</ogc:Literal>
            </ogc:PropertyIsLike>
            <ogc:PropertyIsLike>
              <ogc:PropertyName>laji</ogc:PropertyName>
              <ogc:Literal>%pyorailyalue%</ogc:Literal>
            </ogc:PropertyIsLike>
        </ogc:And>
          </ogc:Filter>
          <se:LineSymbolizer>
